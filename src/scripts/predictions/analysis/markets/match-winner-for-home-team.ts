							...
							},
							{
								...
								fn: ({ homeTeam, leagueStandings }: T_PredictionsInput) => {
									...
									return {
										...
										successExplanation: `El visitante es de los mejores del torneo | (${homeTeamPosition}/${leagueStandings.items.length})`,
										failExplanation: `El visitante no es de los mejores del torneo | (${homeTeamPosition}/${leagueStandings.items.length})`,
									};
								},
							},
							{
